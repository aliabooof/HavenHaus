...
export function getGuestNavbar() {
    return `
...
export function getAuthNavbar(userName = 'User') {
    return `
...
export function renderNavbar() {
    ...
    if (isLoggedIn && user) {
        ...
        navbarContainer.innerHTML = getAuthNavbar();
        ...
        navbarContainer.innerHTML = getGuestNavbar();
    }
}