...
const accessControlList = [
    ...
    { path: '/dashboard-customer.html', allowedRoles: [Roles.CUSTOMER] },
    { path: '/dashboard-seller.html',   allowedRoles: [Roles.SELLER] },
    { path: '/dashboard-admin.html',    allowedRoles: [Roles.ADMIN] },
